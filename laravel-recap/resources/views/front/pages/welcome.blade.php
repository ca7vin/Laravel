...
@section('content')
    ...
    @if (session()->has('message'))
        <div class='alert alert-danger d-flex flex-column align-items-center justify-content-center position-absolute' style='z-index:100 !important; top:100px; width:100%;'>
            {{ session()->get('message') }}
    ...
    @if (session()->has('success'))
        <div class='alert alert-success d-flex flex-column align-items-center justify-content-center position-absolute' style='z-index:100 !important; top:130px; width:100%;'>
            {{ session()->get('success') }}
        </div>
    @endif
