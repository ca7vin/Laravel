...
@section('content-back')
    ...
    <div class="container d-flex flex-column align-items-center justify-content-center">
        <div class='container-fluid d-flex align-items-center justify-content-between my-5'>
            <h2 class="text-uppercase m-0">Liste business</h2>
            <a href="/back/pages/business/business-create" class="btn btn-success">Create</a>
        </div>
            ...
            <tbody>
                @foreach ($dataBusiness as $item)
                    <tr>
                        ...
                        <td>
                            <a href="/back/pages/business/business-edit/{{ $item->id }}" class="btn btn-warning">Edit</a>
                        </td>
                    </tr>
                @endforeach
            </tbody>
