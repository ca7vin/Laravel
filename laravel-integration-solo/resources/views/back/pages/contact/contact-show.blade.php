    ...
    @include('back/partials/sidenav-back')
        ...
        <div class="container d-flex flex-column align-items-center justify-content-center">
          <div class='container-fluid d-flex align-items-center justify-content-between my-5'>
            <h2 class="text-uppercase m-0">Liste contact</h2>
            <a href="/back/pages/contact/contact-create" class="btn btn-success">Create</a>
          </div>
            ...
            <table class="table">
                ...
                <tbody>
                  ...
                  <tr>
                    ...
                    <td>
                      <a href="/back/pages/contact/contact-edit/{{ $item->id }}" class="btn btn-warning">Edit</a>
                    </td>
                  </tr>
                  @endforeach
                </tbody>
